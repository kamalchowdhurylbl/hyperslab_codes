...
main (int argc, char **argv)
{
    ...
    int data_out[X][Y][Z];   //data out 3d is 6x6x6
    int data_out1[X][Y][Z];  //data out1  is 6x6x6  
 ...
 ************************************************************/  
  ...
  //for 3d data
    ...
    if(mpi_rank==0){
        ...
        // offset from 0x0x0 and count 3x3x3
        offset[0] = 0;
        offset[1]=0;
        ...
        */
        ...
        offset_out[1] = 0;
        offset_out[2] = 0;
        count_out[0]  = 3; //count_out=3 X 3 x 3  
        count_out[1]  = 3;   
        count_out[2]  = 3;   
    ...
    //  offset from 3x3x3 and count 2x2x2  
        
        offset[0] = 0;  //offset=0x3x0
        offset[1] = 3;
        offset[2] = 0;
        count[0]  = 3;   //count=3x3x3
        count[1]  = 3;
        count[2]  = 3;
   ...
   if(mpi_rank==1){
    //offset from 0x0x3 and count 3x3x3 
        offset[0] = 3;
        offset[1] = 0;
        offset[2] = 0;    //offset=3x0x0
        count[0]  = 3;
        count[1]  = 3;  //count=3x3x3
        count[2]  = 3;
        status = H5Sselect_hyperslab (dataspace, H5S_SELECT_SET, offset, NULL, count, NULL);  
        ...
        */
        ...
        //  offset from the 0x0x1 and count 2x2x1
        
        offset[0] = 3;
        offset[1] = 3;
        offset[2] = 0;   //offset=3x3x0
        count[0]  = 2;    //count=2x2x1
        count[1]  = 2;
        count[2]  = 1;
        status = H5Sselect_hyperslab (dataspace, H5S_SELECT_SET, offset, NULL, count, NULL);  
    ...
    printf("offset from 3x0x0 and count 3x3x3 \n");
    ...
    if(mpi_rank==0){
        ...
        printf("offset from 0x0x0 and count 3x3x3\n");
        printf("offset from 0x3x0 and count 3x3x3  \n");
