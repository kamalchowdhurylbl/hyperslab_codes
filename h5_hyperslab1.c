 ...
 ************************************************************/  
    ...
    */
    ...
    status = H5Sselect_hyperslab (dataspace, H5S_SELECT_SET, offset, NULL, count, NULL);  //H5S_SELECT_SET=Replace the existing selection with the parameters from this call. Overlapping blocks are not supported with this operator.
