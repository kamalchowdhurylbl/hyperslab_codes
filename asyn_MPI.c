...
main (int argc, char **argv)
{
    ...
    hid_t       dataspace,dataspace1d;   
    hid_t       memspace,memspace1d; 
    hsize_t     dimsm[2],dimsm1d;              /* memory space dimensions */
    hsize_t     dims_out[2],dims_out1d;           /* dataset dimensions */      
    herr_t      status;      
    ...
    hsize_t     count_out1d;          /* size of the hyperslab in memory */
    hsize_t    offset_out1d;
